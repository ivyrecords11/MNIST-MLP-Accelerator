...
HD_PWD='C:/Users/ivyre/Desktop/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log glbl_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source glbl_ctrl.tcl
