...
HD_PWD='C:/Users/ivyre/Desktop/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log glbl_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source glbl_ctrl.tcl -notrace
